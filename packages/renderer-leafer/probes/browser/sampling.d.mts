...
export function assertPlaybackStarted(beforePlay: readonly PlaybackSnapshot[], afterPlay: readonly PlaybackSnapshot[]): void
export function buildWorkEvidence(sampleStart: readonly PlaybackSnapshot[], sampleEnd: readonly PlaybackSnapshot[]): PlaybackWorkEvidence[]
